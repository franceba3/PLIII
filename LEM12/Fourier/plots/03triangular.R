...
df <- read.table("/Users/erwinplanck/Desktop/Physics/Physics Lab III/LEM12/Fourier/plots/data/03triangular",
                 header = FALSE, sep = "\t", dec = ",")

df2 <- read.table("/Users/erwinplanck/Desktop/Physics/Physics Lab III/LEM12/Fourier/plots/data/04triangularfrecuencia", 
                  header = FALSE, sep = "\t", dec = ",")
