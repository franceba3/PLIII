...
df <- read.table("/Users/erwinplanck/Desktop/Physics/Physics Lab III/LEM12/Fourier/plots/data/DCsinusoidal", 
                 header = FALSE, sep = "\t", dec = ",")
df2 <- read.table("/Users/erwinplanck/Desktop/Physics/Physics Lab III/LEM12/Fourier/plots/data/DCfrecuencia", 
                  header = FALSE, sep = "\t", dec = ",")
...
sinusoidal <- function(t) {
  return(8.611*sin(2*pi/1.004 * t) + 1.254)
}
